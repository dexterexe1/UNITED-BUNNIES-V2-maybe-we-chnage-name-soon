...
from bot.database import (
    create_ticket_record, close_ticket_record, claim_ticket_record,
    unclaim_ticket_record, get_ticket_record, get_open_ticket_for_user,
    list_open_tickets,
)
...
@bot.hybrid_command(name="tickets", aliases=["ticketlist"], description="[Staff] List all currently open tickets")
@commands.has_role(REQUIRED_ROLE_ID)
